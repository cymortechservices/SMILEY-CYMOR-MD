...
//  variant tematik (brathd/bratanime/bratpatrick/bratsquidward/
//  bratvermeil), variant VIDEO (bratvid/bratvid2/
...
export async function iqc(ctx) {
    ...
    if (!text) {
        return reply(
            ...
            `Contoh: \`${PREFIX}iqc Smiley Cymor terkuat sejagad raya\``
        );
    }
