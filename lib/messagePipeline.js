...
import { handleSmileyAiChat } from './smileyAi.js';
...
export async function processIncomingMessage(sock, msg) {
    ...
    if (!isCmd) {
        ...
        // Mode chat AI ala Smiley Cymor (.smileyai on/off) — di DM selalu boleh,
        // di grup cuma kalau bot di-mention/di-reply. Lihat lib/smileyAi.js.
        await handleSmileyAiChat(sock, msg, jid, body, isGroup);
        return;
    }
